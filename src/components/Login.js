...
function Login() {
  ...
  document.body.style.background =
    "linear-gradient(to right, rgba(2, 0, 37, .9), rgba(0, 1, 0, 0.9))";
    ...
    <div id="login-container">
      {nav === false ? (
        <form className="form-wrap" onSubmit={handleSubmit}>
          ...
          <div className="cover-input" id="input1">
            ...
            <input
              ...
              onClick={() => changeColor("#input1")}
              onBlur={() => reverseColor("#input1")}
              type="text"
          ...
          <div className="cover-input" id="input2">
            <div className="icon-container">
            ...
            <input
              ...
              onClick={() => changeColor("#input2")}
              onBlur={() => reverseColor("#input2")}
              required
            />
          </div>
          {!state.requestDone ? (
            ...
            <button value="submit" className="login-button" id="loads">
              loading
              <Loader
                type="Puff"
                color="#eee"
